        ...
        <div className="row g-0">
          ...
          <div className="col-md-8">
            <div className="card-body mt-3">
              <h5 className="card-title ml-4">Titulo peli</h5>
              <p className="card-text ml-4">Director:</p>
              <p className="card-text ml-4">Vista general:</p>
              <p className="card-text ml-4">Puntuación:</p>
              <p className="card-text ml-4">Puntuación:</p>
            </div>
          </div>
        </div>
